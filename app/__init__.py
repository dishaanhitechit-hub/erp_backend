...
def create_app():
    ...
    from .modules.project_mgmt.custom_billing.sale_order_billing.routes import sale_order_billing_bp
    app.register_blueprint(sale_order_billing_bp, url_prefix="/project-mgmt/sale-order-billing")

...
class ConcreteRegistry(db.Model):
    ...
    projectcode= db.Column(db.String,db.Foreignkey("projects.project_code"),nullable=False)
    ...
    attach_batch_file = db.Column(db.String(50),nullable=False)

    code=db.relationship("Project",backref="concrete_registry",lazy="dynamic")